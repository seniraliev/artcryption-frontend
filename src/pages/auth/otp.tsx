...
import {AssetsBoxContainer, FooterContainer, LogoText, LeftContainer, StyledContainer, LogoContainer, MainContainer, RightContainer, ExtendedContainer, Header} from "../../components/Pages/Auth/styled";
