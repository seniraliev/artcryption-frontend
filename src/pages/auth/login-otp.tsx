...
import {AssetsBoxContainer, FooterContainer, LogoText, LeftContainer, StyledContainer, LogoContainer, MainContainer, RightContainer, Header} from "../../components/Pages/Auth/styled";
